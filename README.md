# Sequent Microsystems Sixteen 0-10V Analog Outputs Home Assistant Integration

Integrate [Sixteen 0-10V Analog Outputs](https://sequentmicrosystems.com/products/sixteen-0-10v-analog-outputs)
...
5. Add SM16uout config in configuration.yaml
    ...
    - At the end of the file append the SM16uout config:
        ```yaml
        SM16uout:
        ```
...
Possible entities:
```yaml
out_1: -> out_16:  (type: number)
led_1: -> led_16:  (type: switch)
```
